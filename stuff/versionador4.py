...
def write_to_output():
    ...
    with open(output_file_path, 'w', encoding='utf-8') as output_file:  # Abre o arquivo de saída com UTF-8
        for file_path in file_paths:
            if os.path.exists(file_path):  # Verifica se o arquivo existe
                with open(file_path, 'r', encoding='utf-8') as f:  # Abre os arquivos de entrada com UTF-8
                    content = f.read()
